...
def getIfSpeed():
  ...
  slots = {
    '1.3.6.1.2.1.31.1.1.1.6.560': 'GeneralPurpose-UpLink',
    '1.3.6.1.2.1.31.1.1.1.6.520': 'Tier1-UpLink',
    '1.3.6.1.2.1.31.1.1.1.6.267': 'INFN-CC-UpLink',
    '1.3.6.1.2.1.31.1.1.1.6.315': 'Sezione-UpLink',
    '1.3.6.1.2.1.31.1.1.1.6.516': 'Cloud',
    '1.3.6.1.2.1.31.1.1.1.6.641': '16816-Uplink_VLAN-1100'
  }
  ...
  getCmd(
     ...
     UdpTransportTarget(('90.147.168.1', 161)),
     ContextData(),
     ObjectType(ObjectIdentity('IF-MIB','ifHCInOctets', 560)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCInOctets', 267)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCInOctets', 315)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCInOctets', 520)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCInOctets', 516)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCInOctets', 641)),
  ))
  ...
  slots = {
    '1.3.6.1.2.1.31.1.1.1.10.560': 'GeneralPurpose-UpLink',
    '1.3.6.1.2.1.31.1.1.1.10.520': 'Tier1-UpLink',
    '1.3.6.1.2.1.31.1.1.1.10.267': 'INFN-CC-UpLink',
    '1.3.6.1.2.1.31.1.1.1.10.315': 'Sezione-UpLink',
    '1.3.6.1.2.1.31.1.1.1.10.516': 'Cloud',
    '1.3.6.1.2.1.31.1.1.1.10.641': '16816-Uplink_VLAN-1100'
  }
  ...
  getCmd(
     ...
     UdpTransportTarget(('90.147.168.1', 161)),
     ContextData(),
     ObjectType(ObjectIdentity('IF-MIB','ifHCOutOctets', 560)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCOutOctets', 315)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCOutOctets', 520)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCOutOctets', 267)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCOutOctets', 516)),
     ObjectType(ObjectIdentity('IF-MIB','ifHCOutOctets', 641)),
  ))
